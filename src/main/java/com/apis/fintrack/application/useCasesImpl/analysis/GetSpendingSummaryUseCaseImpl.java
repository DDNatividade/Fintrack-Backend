package com.apis.fintrack.application.useCasesImpl.analysis;

import com.apis.fintrack.application.analysis.GetSpendingSummaryUseCase;
...
public final class GetSpendingSummaryUseCaseImpl implements GetSpendingSummaryUseCase {
    ...
    public GetSpendingSummaryUseCaseImpl(TransactionSummaryPort transactionSummaryPort) {
    ...
    public SpendingSummary getSummary(Long userId, AnalysisPeriod period) {
        ...
        // TODO: There is no output port to count transactions for the given user/period.
        // Add a TransactionCountPort or similar to obtain this value from the infrastructure layer.
