...
public class CreateSubscriptionUseCaseImpl implements CreateSubscriptionUseCase {
    ...
    public Subscription create(CreateSubscriptionCommand command) {
        ...
        var maybeUser = com.apis.fintrack.domain.user.model.User.create(command.userId());
        var maybeUser = com.apis.fintrack.domain.user.model.User.createWithId(command.userId());
