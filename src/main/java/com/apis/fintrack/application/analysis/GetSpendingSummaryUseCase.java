 ...
 * This is a domain-level contract; implementations in the application layer
 * should orchestrate retrieval of aggregated transaction data and map it to
 * a SpendingSummary domain model.
 */
