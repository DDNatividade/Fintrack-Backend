 ...
 *
 * Se coloca en el paquete de dominio porque los puertos ya referencian
 * com.apis.fintrack.domain.analysis.model.SpendingSummary. Es inmutable
 * y contiene la información agregada calculada por los casos de uso.
 */
public final class SpendingSummary {
    ...
    private final Map<String, BigDecimal> breakdownByCategory;
    ...
    public Map<String, BigDecimal> getBreakdownByCategory() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(totalSpending, periodStart, periodEnd, breakdownByCategory, countTransactions);
    }
