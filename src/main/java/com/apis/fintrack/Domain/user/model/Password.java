...
/**
 * Value Object que representa una contraseÃ±a.
 *
 * Responsabilidades:
 ...
 * - Hashear la contraseÃ±a (eso lo hace PasswordEncoder en infraestructura)
 *
 * CaracterÃ­sticas:
 * - Inmutable
...
public final class Password {
     ...
     * Usar para contraseÃ±as nuevas (registro, cambio de contraseÃ±a).
     *
     * @param plainText la contraseÃ±a en texto plano
    ...
    /**
     * Crea una Password sin validaciÃ³n.
    ...
    /**
     * Valida que la contraseÃ±a cumpla los requisitos de seguridad.
     */
    private static void validate(String plainText) {
        ...
        if (plainText.length() < MIN_LENGTH) {
            throw new IllegalArgumentException(
                "La contraseÃ±a debe tener al menos " + MIN_LENGTH + " caracteres"
            );
        }
    ...
    /**
     * No expone el valor de la contraseÃ±a por seguridad.
     */
    @Override
