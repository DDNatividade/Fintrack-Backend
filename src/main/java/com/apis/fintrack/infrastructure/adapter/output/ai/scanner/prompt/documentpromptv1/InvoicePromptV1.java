 ...
 */
public final class InvoicePromptV1 {

    private InvoicePromptV1() {
        // utility class
    }
    ...
    public static String value() {
        return "SYSTEM MESSAGE:\n" +
                ...
                "- Identify invoice total and line-item amounts.\n" +
                "- Extract currency information near totals.\n" +
                "- Extract invoice date and due date if present; prefer invoice date as suggestedDate.\n" +
                "- Extract invoice reference or description lines.\n" +
                "- Extract supplier name as merchant.\n" +
                "- For each billable line or the invoice total, create a draft entry.\n" +
                ...
                "- Content: An invoice with a total of 1250.00 USD issued on 2024-06-01.\n\n" +
                "Example Output:\n" +
                "{\n" +
                "  \"drafts\": [\n" +
                "    {\n" +
