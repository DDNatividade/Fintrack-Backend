...
import com.apis.fintrack.domain.subscription.model.payment.model.PaymentId;
...
public class PaymentPersistenceMapper {
    ...
    public Payment toDomain(PaymentJPAEntity jpaEntity) {
        ...
        return new Payment(
            ...
            Money.zero(), // Amount not stored in JPA entity - consider adding
            true // Assuming paid if persisted
        );
    }
