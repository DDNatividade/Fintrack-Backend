...
public class DataInitializer {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            // === Crear propiedades ===
            PropertyJPAEntity read = new PropertyJPAEntity(0, PropertyEnum.READ, new HashSet<>());
            PropertyJPAEntity write = new PropertyJPAEntity(0, PropertyEnum.WRITE, new HashSet<>());
            PropertyJPAEntity delete = new PropertyJPAEntity(0, PropertyEnum.DELETE, new HashSet<>());
            PropertyJPAEntity update = new PropertyJPAEntity(0, PropertyEnum.UPDATE, new HashSet<>());
            PropertyJPAEntity create = new PropertyJPAEntity(0, PropertyEnum.CREATE, new HashSet<>());
